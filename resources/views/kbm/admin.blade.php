...
<body>
    ...
    <div>
        ...
        <div class="filter-container">
            <label>Cari:</label>
            <input type="text" id="search" placeholder="Cari guru, mapel, atau hari...">
    ...
    $(document).ready(function() {
        ...
        function renderTable(data) {
            let rows = '';
            if (data.length === 0) {
                rows = '<tr><td colspan="7">Tidak ada jadwal ditemukan</td></tr>';
            } else {
        ...
        function loadKBM() {
            $.ajax({
                ...
                error: function() {
                    $('#tabel-kbm tbody').html('<tr><td colspan="7">Gagal memuat data jadwal.</td></tr>');
                    hideLoading();
                }
            });
        }
